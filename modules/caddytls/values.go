...
var defaultCipherSuitesWithAESNI = []uint16{
	...
	// additional ciphers for Windows (ECDHE only as we use ECC keys)
	tls.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA_P256,
	tls.TLS_ECDHE_ECDSA_WITH_AES_256_CBC_SHA_P384,
	tls.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA_P256,
	tls.TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA_P384,
	tls.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA_P256,
	tls.TLS_ECDHE_RSA_WITH_AES_256_CBC_SHA_P384,
	tls.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA_P256,
	tls.TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA_P384,
}
